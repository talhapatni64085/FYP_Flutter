...
import 'package:ground_app/Screens/confirmedBookingDetails.dart';
import 'package:ground_app/Screens/groundHistoryDetails.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("My Bookings History"),
        ),
        body: StreamBuilder<QuerySnapshot>(
          ...
          builder:
            ...
            if (snapshot.data!.size == 0) {
              return Center(child: Text('You have not booking history yet!'));
            }
                ...
                return InkWell(
                  ...
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => ConfirmedBookingDetails(

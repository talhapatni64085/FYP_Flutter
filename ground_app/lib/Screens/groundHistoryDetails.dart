...
class GroundHistoryDetails extends StatefulWidget {
  final String documentId;
  GroundHistoryDetails({Key? key, required this.documentId}) : super(key: key);

  @override
  State<GroundHistoryDetails> createState() => _GroundHistoryDetailsState();
}

class _GroundHistoryDetailsState extends State<GroundHistoryDetails> {

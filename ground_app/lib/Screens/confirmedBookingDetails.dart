...
class ConfirmedBookingDetails extends StatefulWidget {
  final String documentId;
  ConfirmedBookingDetails({Key? key, required this.documentId}) : super(key: key);

  @override
  State<ConfirmedBookingDetails> createState() => _ConfirmedBookingDetailsState();
}

class _ConfirmedBookingDetailsState extends State<ConfirmedBookingDetails> {

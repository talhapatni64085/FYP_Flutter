...
class TournamentRequests extends StatefulWidget {
  const TournamentRequests({Key? key}) : super(key: key);

  @override
  _TournamentRequestsState createState() => _TournamentRequestsState();
}

class _TournamentRequestsState extends State<TournamentRequests> {
  var size, height, width;
  final Stream<QuerySnapshot> _usersStream = FirebaseFirestore.instance
      .collection('tournamentBooking')
      .where('tournamentUID',isEqualTo: user!.uid)
      .where('status', whereIn: ['Approved', 'Cancelled by user', 'Cancelled by organizer'])
      .snapshots();

...
class MyPendingTournaments extends StatefulWidget {
  const MyPendingTournaments({Key? key}) : super(key: key);

  @override
  _MyPendingTournamentsState createState() => _MyPendingTournamentsState();
}

class _MyPendingTournamentsState extends State<MyPendingTournaments> {
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => MyPendingTournamentDetails(

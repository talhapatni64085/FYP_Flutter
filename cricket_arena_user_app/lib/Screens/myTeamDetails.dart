...
class MyTeamDetails extends StatefulWidget {
  ...
  const MyTeamDetails({Key? key, required this.documentId, required this.captain}) : super(key: key);
...
class _MyTeamDetailsState extends State<MyTeamDetails> {
  ...
  Future makeCaptain() async {
    FirebaseFirestore.instance
        .collection('invitations')
        .doc(widget.documentId)
        .update({"date": "Captain"}).then((value) => print('Success'));
  }
  Future DeleteRequest(id) async {
    FirebaseFirestore.instance
        .collection('users')
        .doc(id)
        .update({'team': '-'}).then((value) => print('success1234'));
    FirebaseFirestore.instance
        .collection('invitations')
        .doc(widget.documentId)

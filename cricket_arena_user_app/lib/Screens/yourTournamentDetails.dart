...
class yourTournamentDetails extends StatefulWidget {
  final String documentId;
  yourTournamentDetails({Key? key, required this.documentId})
      : super(key: key);

  @override
  State<yourTournamentDetails> createState() => _yourTournamentDetailsState();
}

class _yourTournamentDetailsState extends State<yourTournamentDetails> {
...
Future completedTournament() async {

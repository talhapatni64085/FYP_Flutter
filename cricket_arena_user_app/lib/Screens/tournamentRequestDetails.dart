...
class TournamentRequestDetails extends StatefulWidget {
  final String documentId;
  TournamentRequestDetails({Key? key, required this.documentId})
      : super(key: key);

  @override
  State<TournamentRequestDetails> createState() => _TournamentRequestDetailsState();
}

class _TournamentRequestDetailsState extends State<TournamentRequestDetails> {

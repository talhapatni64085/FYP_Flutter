...
class AdminGroundDetails extends StatefulWidget {
  final String documentId;
  AdminGroundDetails({Key? key, required this.documentId})
      : super(key: key);

  @override
  State<AdminGroundDetails> createState() => _AdminGroundDetailsState();
}

class _AdminGroundDetailsState extends State<AdminGroundDetails> {
                      ...
                      return ListView(
                        ...
                        padding: EdgeInsets.symmetric(horizontal: 10),
                            ...
                            child: MaterialButton(
                              onPressed: () {
                                final collection = FirebaseFirestore.instance.collection('Grounds');
                            collection 
                                .doc(widget.documentId) // <-- Doc ID to be deleted. 
                                .delete() // <-- Delete
                                .then((_) => (Navigator.pop(context)))
                                .catchError((error) => print('Delete failed: $error'));
                                Fluttertoast.showToast(msg: 'Ground Deleted successfully');
                                },
                              color: Colors.white,
                              height: 45,
                              elevation: 0,

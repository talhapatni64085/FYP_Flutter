...
class AdminGroundBookingDetails extends StatefulWidget {
  final String documentId;
  AdminGroundBookingDetails({Key? key, required this.documentId})
      : super(key: key);

  @override
  State<AdminGroundBookingDetails> createState() => _AdminGroundBookingDetailsState();
}

class _AdminGroundBookingDetailsState extends State<AdminGroundBookingDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Booked Ground Profile"),
      ),
                      ...
                      return ListView(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                ListTile(
                                  ...
                                  title: Text("Rs: ${data['ground price']}",
                                      style: TextStyle(color: Colors.white)),
                                ),
                                Divider(color: Color.fromARGB(214, 102, 50, 98)),
                                ListTile(
                                ...
                                ListTile(
                                    leading: Icon(Icons.phone,
                                        color: Colors.white),
                                    title: Text(
                                      "Ground Contact: ${data['ground contact']}",
                                      style: TextStyle(color: Colors.white),
                                    )),
                                Divider(color: Color.fromARGB(214, 102, 50, 98)),
                                ListTile(
                        ...
                        padding: EdgeInsets.symmetric(horizontal: 10),
                            ...
                            child: MaterialButton(
                              onPressed: () {
                                final collection = FirebaseFirestore.instance.collection('groundBookings');
                            collection 

...
class MyPendingTournamentDetails extends StatefulWidget {
  final String documentId;
  MyPendingTournamentDetails({Key? key, required this.documentId})
      : super(key: key);

  @override
  State<MyPendingTournamentDetails> createState() => _MyPendingTournamentDetailsState();
}

class _MyPendingTournamentDetailsState extends State<MyPendingTournamentDetails> {
  ...
  Future completeTournament() async {
    FirebaseFirestore.instance
        .collection('tournamentBooking')
        .doc(widget.documentId)
        .update({"status": "Cancelled by user"}).then((value) => print('Success'));
  }
}
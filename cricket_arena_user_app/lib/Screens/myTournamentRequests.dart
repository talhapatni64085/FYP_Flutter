...
import 'package:user_app/Screens/myTournamentRequestDetails.dart';
...
class MyTournamentRequests extends StatefulWidget {
  const MyTournamentRequests({Key? key}) : super(key: key);

  @override
  _MyTournamentRequestsState createState() => _MyTournamentRequestsState();
}

class _MyTournamentRequestsState extends State<MyTournamentRequests> {
  var size, height, width;
  final Stream<QuerySnapshot> _usersStream = FirebaseFirestore.instance
      .collection('tournamentBooking')
      .where('uid',isEqualTo: user!.uid)
      .where('status', whereIn: ['Approved', 'Cancelled by organizer', 'Cancelled by user'])
      .snapshots();
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => MyTournamentRequestDetails(

...
class MyMatchRequests extends StatefulWidget {
  @override
  State<MyMatchRequests> createState() => _MyMatchRequestsState();
}

class _MyMatchRequestsState extends State<MyMatchRequests> {
                ...
                return InkWell(
                  ...
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => MyMatchRequestDetails(

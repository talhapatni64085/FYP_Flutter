...
class AdminGrounds extends StatefulWidget {
  const AdminGrounds({Key? key}) : super(key: key);

  @override
  _AdminGroundsState createState() => _AdminGroundsState();
}

class _AdminGroundsState extends State<AdminGrounds> {
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => AdminGroundDetails(

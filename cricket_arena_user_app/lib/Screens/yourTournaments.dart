...
class YourTournaments extends StatefulWidget {
  const YourTournaments({Key? key}) : super(key: key);

  @override
  _YourTournamentsState createState() => _YourTournamentsState();
}

class _YourTournamentsState extends State<YourTournaments> {
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => yourTournamentDetails(

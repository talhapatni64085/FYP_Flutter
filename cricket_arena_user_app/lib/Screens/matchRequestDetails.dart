...
class MatchRequestDetails extends StatefulWidget {
  final String documentId;
  final bool isApprove;
  MatchRequestDetails({Key? key, required this.documentId, required this.isApprove}) : super(key: key);

  @override
  State<MatchRequestDetails> createState() => _MatchRequestDetailsState();
}

class _MatchRequestDetailsState extends State<MatchRequestDetails> {
  ...
  Future cancelledByUser() async {
    ...
    Future approved() async {
    FirebaseFirestore.instance
        .collection('teamVsTeam')
        .doc(widget.documentId)
        .update({"status": "Approved"}).then(
            (value) => print('Success'));
  }
}
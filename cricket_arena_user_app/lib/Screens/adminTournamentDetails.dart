...
class AdminTournamentDetails extends StatefulWidget {
  final String documentId;
  AdminTournamentDetails({Key? key, required this.documentId})
      : super(key: key);

  @override
  State<AdminTournamentDetails> createState() => _AdminTournamentDetailsState();
}

class _AdminTournamentDetailsState extends State<AdminTournamentDetails> {
                      ...
                      return ListView(
                        ...
                        padding: EdgeInsets.symmetric(horizontal: 10),
                            ...
                            collection 
                                ...
                                Fluttertoast.showToast(msg: 'Tournament Deleted successfully');
                                },
                              color: Colors.white,
                              height: 45,
                              elevation: 0,
